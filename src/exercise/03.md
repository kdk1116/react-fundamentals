...
Understanding how jsx can be used instead of tediously typing everything like so: 
```javascript 
const worldElement = 'Hello World'
const containerElement = 'container'
const props = {worldElement, containerElement}
 React.createElement('div', props) // or React.createElement('div', {...props})
``` 

And replacing it with this cleaner method: 
```jsx 
const worldElement = 'Hello World'
const containerElement = 'container'
const props = {
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=kevin.d.kim1116%40gmail.com).
