...
This one was really tricky for me to understand where I was going wrong with my initial function 
```javascript
<body>
  <div id="root"></div>
...
The reason why is very subtle its because the props object being passed into the function isn't declared as a javascript expression 
but rather a variable. Or in more simple terms were not destructuring the props object. 

To fix this we can either call the props key such as 
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=kevin.d.kim1116%40gmail.com).
